...
import capstone.is4103capstone.finance.requestsMgmt.model.RequestFormModel;
...
public class TTFormResponse extends GeneralRes {
    ...
    public TTFormResponse(String message, Boolean hasError, RequestFormModel form, String approvalStatus) {
